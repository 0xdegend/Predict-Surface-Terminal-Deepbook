  ...
  return (
    ...
    <main className="rise grid flex-1 grid-cols-1 gap-px bg-white/6 lg:grid-cols-[minmax(0,1fr)_340px] xl:grid-cols-[minmax(0,1fr)_380px]">
      ...
      <aside className="flex min-w-0 flex-col gap-6 bg-bg-0 p-4 sm:p-5">
        {/* Instant trading (delegated session) is controlled from the nav wallet
            dropdown now (WalletInstantTrading), not a panel on top of the ticket.
            The SessionPill in the ticket heading is the at-a-glance "on" indicator. */}
        {paused ? (
