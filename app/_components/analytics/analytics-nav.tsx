...
export const TOOLS: {
...
}[] = [
  {
    id: "pulse",
    label: "Pulse",
    desc: "The whole market at a glance",
    icon: LuLayoutDashboard,
  },
  {
    id: "markets",
    label: "Markets",
    desc: "Where the action is",
    icon: LuGrid3X3,
  },
  {
    id: "sentiment",
    label: "Sentiment",
    desc: "UP vs DOWN bets",
    icon: LuGauge,
  },
  {
    id: "vol",
    label: "Price swings",
    desc: "How jumpy each market is",
    icon: LuWaves,
  },
  {
    id: "styles",
    label: "Trader styles",
    desc: "How the top traders bet",
    icon: LuUsers,
  },
  {
    id: "flow",
    label: "Live bets",
    desc: "Every bet as it happens",
    icon: LuActivity,
  },
];
        ...
        {TOOLS.map((t) => {
          ...
          return (
            ...
            >
              <Icon
                size={15}
                className={`flex-none ${isActive ? "text-accent" : "text-text-3"}`}
              />
              {t.label}
            </button>
          );
