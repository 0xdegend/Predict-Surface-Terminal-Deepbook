...
export const metadata: Metadata = {
  title: 'Competitions',
  description:
    'Degen Arena: Skew’s faction competition. Factions compete each season for a share of a USDC prize pool, split by faction rank and by each member’s performance.',
};
