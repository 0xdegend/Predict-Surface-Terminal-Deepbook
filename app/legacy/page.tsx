...
// The legacy trade terminal. Root (/) now lands on the Latest release (/v2);
// this page is reachable via the Legacy↔Latest toggle for traders who still
// need the old deployment (e.g. to claim positions from Portfolio). The legacy
// testnet backend is wound down, so the snapshot fetch fails and the page shows
// the inert, blurred terminal with an "offline" caption — the live nav stays.
